    ...
    <section class="why container" id="why">
      ...
      <div class="features-grid">
        <article class="feature-card">
          ...
          <p>Get your vehicle valuation in seconds, no waiting required</p>
        </article>
        <article class="feature-card">
          <div class="icon-sq">📈</div>
          <h3>Market Trends</h3>
          <p>Real-time data and historical trends to understand market movements</p>
        </article>
        <article class="feature-card">
          <div class="icon-sq">🔒</div>
          <h3>Accurate & Reliable</h3>
          <p>98% accuracy backed by comprehensive market data analysis</p>
        </article>

        <article class="feature-card">
          <div class="icon-sq">📊</div>
          <h3>Detailed Analysis</h3>
          <p>Comprehensive breakdown of factors affecting your vehicle's value</p>
        </article>
        <article class="feature-card">
          <div class="icon-sq">🚗</div>
          <h3>Compare Vehicles</h3>
          <p>See how your vehicle compares to similar models in the market</p>
        </article>
        <article class="feature-card">
          <div class="icon-sq">✅</div>
          <h3>Free Service</h3>
          <p>No hidden fees, completely free vehicle valuation service</p>
        </article>
      </div>
    </section>
    ...
    <section class="how container" id="how">
      ...
      <div class="steps-row">
        <div class="step">
          ...
          <h4>Enter Details</h4>
          <p>Provide your vehicle's make, model, year, mileage, and condition</p>
        </div>
        <div class="step">
          <div class="step-num">2</div>
          <h4>Instant Analysis</h4>
          <p>Our algorithm analyzes market data and calculates your vehicle's value</p>
        </div>
        <div class="step">
          <div class="step-num">3</div>
          <h4>Get Results</h4>
          <p>View detailed valuation with market trends and comparisons</p>
        </div>
      </div>
    </section>
