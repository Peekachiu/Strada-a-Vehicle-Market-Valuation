...
export function renderHero(container) {
  container.insertAdjacentHTML('beforeend', `
    ...
    <section class="new-features container" id="why">
      <div class="new-section-header reveal-on-scroll">
      ...
      <div class="new-features-grid">
        <article class="new-feature-card reveal-on-scroll stagger-1">
        ...
        <article class="new-feature-card reveal-on-scroll stagger-2">
          <div class="new-feature-icon">
        ...
        <article class="new-feature-card reveal-on-scroll stagger-3">
          <div class="new-feature-icon">
    ...
    <!-- How it works -->
    <section class="new-how-it-works container reveal-on-scroll" id="how">
      ...
      <div class="new-steps-grid">
        <div class="new-step reveal-on-scroll stagger-1">
        ...
        <div class="new-step reveal-on-scroll stagger-2">
        ...
        <div class="new-step reveal-on-scroll stagger-3">
    ...
    <!-- Dark CTA Banner -->
    <section class="new-cta-section container reveal-on-scroll">
      <div class="new-cta-card">
        ...
        <div class="cta-actions">
          <!-- Updated: data-navigate attribute -->
          <button id="banner-start" class="btn btn-secondary btn-lg animate-pulse" data-navigate="valuation">
            Get Started Now
            <svg class="icon-arrow" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg>
          </button>
        </div>
